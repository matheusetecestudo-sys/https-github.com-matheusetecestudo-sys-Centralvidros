            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/20 to-transparent opacity-100">
                <div className="absolute bottom-0 left-0 p-5 md:p-6 w-full text-center md:text-left">
                  ...
                  <div className="inline-block bg-gradient-to-r from-emerald-600 to-emerald-500 text-white text-[8px] font-black px-4 py-2 rounded-full uppercase tracking-tighter shadow-lg transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all">
                    ORÇAR NO WHATSAPP
                  </div>
                </div>
              </div>
