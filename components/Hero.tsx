        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal active text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href={WHATSAPP_LINK}
                className="inline-flex items-center justify-center gap-3 px-10 py-6 text-base font-black text-white bg-emerald-600 rounded-2xl shadow-xl shadow-emerald-600/30 hover:bg-emerald-700 transition-all hover:scale-105 active:scale-95 uppercase tracking-wide"
              >
                {CTA_TEXT}
