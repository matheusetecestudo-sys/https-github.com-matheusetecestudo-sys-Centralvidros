        ...
        <div className="container-precision flex justify-between items-center h-12">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="hidden lg:flex items-center justify-center gap-2 px-8 h-12 bg-brand-whatsapp text-white rounded-xl font-bold text-sm btn-interact shadow-xl shadow-brand-whatsapp/10 focus:outline-none whitespace-nowrap"
            >
