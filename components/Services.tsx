              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-8 flex flex-col justify-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-lg shadow-emerald-600/20 hover:shadow-emerald-600/40 hover:-translate-y-0.5 active:scale-95 transition-all"
                  >
                    {CTA_TEXT}
                  </a>
                </div>
