              ...
              <div className="relative bg-slate-900 ring-1 ring-white/10 backdrop-blur-3xl p-6 md:p-8 lg:p-14 rounded-3xl shadow-2xl">
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <div>
                    ...
                    <p className="!text-slate-300 text-[10px] font-bold uppercase tracking-widest">Consultoria Gratuita</p>
                  </div>
                </div>
                <p className="!text-slate-200 mb-10 font-medium text-base leading-relaxed">
                ...
                <a
                  ...
                  className="w-full h-16 flex items-center justify-center gap-3 bg-brand-whatsapp hover:bg-[#128C7E] text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-brand-whatsapp/20 hover:shadow-xl hover:shadow-brand-whatsapp/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
                >
