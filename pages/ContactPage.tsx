                  ...
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest group-hover:text-white/70 transition-colors">Resposta em até 15 minutos</span>
                      </div>
                    </div>
