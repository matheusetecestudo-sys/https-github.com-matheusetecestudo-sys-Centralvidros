          ...
          {ALL_SERVICES.map((service) => (
            ...
            >
              ...
              <a
                ...
                className="w-full py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-xl font-black text-[11px] text-center uppercase tracking-widest shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:-translate-y-0.5 transition-all active:scale-95"
              >
                {CTA_TEXT}
              </a>
            </div>
        ...
        <div className="mt-20 p-8 md:p-16 bg-slate-900 rounded-[3rem] text-center relative overflow-hidden reveal active">
          <div className="relative z-10">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-12 py-6 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-emerald-600/20 hover:shadow-emerald-600/40 hover:-translate-y-1 transition-all active:scale-95"
            >
              {CTA_TEXT}
            </a>
          </div>
